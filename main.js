...
function createCircle() {
    ...
    //second circle
    if (x2 > canvas.width - r2 || x2 < r2) {
        vx2 = -vx2;
    }
    if (y2 > canvas.height - r2 || y2 < r2) {
        vy2 = -vy2;
    }
    x2 += vx2;
    y2 += vy2;
    ...
    //forth circle
    if (x4 > canvas.width - r4 || x4 < r4) {
        vx4 = -vx4;
    }
    if (y4 > canvas.height - r4 || y4 < r4) {
        vy4 = -vy4;
    }
    x4 += vx4;
    y4 += vy4;
    ...
    //five circle
    if (x5 > canvas.width - r5 || x5 < r5) {
        vx5 = -vx5;
    }
    if (y5 > canvas.height - r5 || y5 < r5) {
        vy5 = -vy5;
    }
    x5 += vx5;
    y5 += vy5;
    ...
    //six circle
    if (x6 > canvas.width - r6 || x6 < r6) {
        vx6 = -vx6;
    }
    if (y6 > canvas.height - r6 || y6 < r6) {
        vy6 = -vy6;
    }
    x6 += vx6;
    y6 += vy6;
